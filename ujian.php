...
<html lang="en">
  <head>
   ...
   <title> UAS  MUHAMAD RIZKY FAUZAN</title>
  </head>
  <body class=body> 
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="" alt="" height=50 class="rounded-circle"></a>
  ...
  <br>
    <div class="text-center"
        <img src="" class="rounded-circle" alt="..." height="250">
    </div> <br>
    <h3 align=center class=text-white>GAJII SEKOLAHH<b></h3>
    <h3 align=center class=text-white>SMK ASSALAAM</b></h3>
    <br><br>
        ...
        <form action="" method="post">
            ...
            <div class="row" id="penggajian">
              <div class="col">
                ...
                <option value="Headmaster">KEPSEK</option>
            ...
            <select name="status" id="" required>
                <option value="still">TETAP</option>
  ...
  $infaq = $_POST ['infaq'];
    ...
    class Hasil{
      ...
      public function hasilnya($no, $name, $unit, $tanggal, $jabatan, $gaji, $lamaKerja, $status, $bonus, $bpjs, $pinjaman, $cicilan, $infaq, $gajiBersih){
        ...
        <table border=0>
        <tr>
            <th colspan=2>MUHAMAD RIZKY FAUZAN</th>
        </tr>
        <tr>
